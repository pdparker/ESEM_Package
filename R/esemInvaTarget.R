...
#' @param Use Numeric indication of variables for usevariables.
...
#' @param Pattern A list where elements 1 to N  consist of the number of the first and last item assigned to target loadings.
#' @param LatentNames The names to be assigned to the 1 to N requested latent variables
#'  
#' @export
#' @examples
#' data(simData)
